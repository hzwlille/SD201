...
def purity(clustering, ground_truth) :
    ...
    for cluster_index in labels2docIds :
        ...
        ## We recommend you to build a histogram category: # of docs, from the documents of the cluster, e.g., 
...
##	totalSum=totalSum+vMax/somme/somme*n_documents
##	print "**********************"+ str(vMax/somme)
	totalSum=totalSum+vMax/somme*(somme/n_documents)
...
def entropy(clustering, ground_truth) :
    ...
    for cluster_index in labels2docs :
        ...
        for docIdx in labels2docs[cluster_index]:
                if ground_truth[docIdx].category not in histogram_ground_truth :
                        histogram_ground_truth[ground_truth[docIdx].category] = 0 ##Initialize the list
                if ground_truth[docIdx].category in histogram_ground_truth :
                        histogram_ground_truth[ground_truth[docIdx].category] = histogram_ground_truth[ground_truth[docIdx].category]+1
        somme=0.0
        entropy=0.0
